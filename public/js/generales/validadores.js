...
function validarVehiculo(entrada){
	if(entrada.length != ''){
		return true;
	}else{
		//TODO: Generamos notificación
		alert('Favor de ingresar un valor válido');//TODO: Quitar alert por notificación		
		return false;
	}
}

function validamosNumeroTaxi(entrada){
	if(entrada.length != ''){
		return true;
	}else{
		//TODO: Generamos notificación
...
function validamosNumeroPlaca(entrada){
	if(entrada.length != ''){
		return true;
	}else{
		//TODO: Generamos notificación
